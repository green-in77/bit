...
public class CustomerController {
	...
	*/
	...
	public String writeBoardOk(Notice notice, HttpServletRequest request) {
		...
		System.out.println(file.getName()); //저장파일명
		System.out.println(file.getOriginalFilename()); //원본파일명
		System.out.println(file.getContentType()); //파일타입
		System.out.println(file.getBytes().length); //파일크기
		
		//POINT : DB에 파일명을 저장할 수 있다.
		notice.setFileSrc(file.getOriginalFilename());
	...
	public String editboardOk(Notice notice,HttpServletRequest request) {
		...
		try {
			...
			System.out.println("fileedit : " + e.getMessage());
		}
