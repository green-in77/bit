	    	...
	    	$(function(){
	    		...
	    		$.ajax({
	    			...
	    			success: function(dept){
	    				...
	    				$.each(dept.data,function(index,data){
	    					//console.log(data);
				...
				<div class="col-lg-12 data-padding">
					<div class="card mb-5 mb-lg-0">         
						...
						<div class="card-body body-padding text-center">
				        	...
				        	<form id="editForm" action="empAddOk.htm" class="mt-4" method="post" enctype="multipart/form-data">
				              ...
				              <div class="form-group mb-4"><!-- 사진 -->
				                <input type="file" name='file' id='emp_img' placeholder="Image" class="form-control border-0 shadow form-control-lg text-violet">
				              </div>
