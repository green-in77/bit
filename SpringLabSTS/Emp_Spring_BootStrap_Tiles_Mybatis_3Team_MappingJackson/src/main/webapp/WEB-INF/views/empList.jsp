					...
					$.ajax({
						...
						success : function(data){//서버에서 받은 응답이 정상이라면, 4 + 200~299
							...
							if( data.data != 0 ) {
			                    ...
			                    selectData = '<div class="d-flex justify-content-between align-items-start align-items-sm-center mb-4 flex-column flex-sm-row">'
			                    				+'<div class="left d-flex align-items-center" style="width:80%">'
			                           				+'<div class="icon icon-lg shadow mr-3 text-gray"><img src="emp_img/'+data.data[0].save_picture+'" alt="Jason Doe" style="max-width: 2.5rem;" class="img-fluid rounded-circle shadow"></div>'
			                              				+'<div class="text" style="width:15%;">'
			                                   				+'<h6 class="mb-0 d-flex align-items-center">'
			                               						+'<span>'+data.data[0].ename+'</span>'
			                           						+ '</h6>'
			                           						+'<small class="text-gray">'+data.data[0].empno+'</small>'
			                      						+'</div>'
			                           				+'<div class="text" style="width:20%;">'
			                           					+'<h6>'+data.data[0].job+'</h6>'
			                           				+'</div>'
			                           				+'<div class="text" style="width:10%;">'
			                           					+'<h6>'+data.data[0].mgr+'</h6>'
			                           				+'</div>'
			                           				+'<div class="text" style="width:20%;">'
			                           					+'<h6>'+data.data[0].hiredate+'</h6>'
			                           				+'</div>'
			                           				+'<div class="text" style="width:14%;">'
			                           					+'<h6>'+data.data[0].sal+'</h6>'
			                           				+'</div>'
			                           				+'<div class="text" style="width:13%;">'
			                           					+'<h6>'+data.data[0].comm+'</h6>'
			                           				+'</div>'
			                           				+'<div class="text" style="width:13%;">'
			                           					+'<h6>'+data.data[0].deptno+'</h6>'
			                           				+'</div>'
			                        	  		+'</div>'
				                        		+'<div class="right ml-5 ml-sm-0 pl-3 pl-sm-0 text-violet" style="width:7%">'
				                           			+'<a href="empEdit.do?empno='+data.data[0].empno+'"><span>수정</span></a>'
				                           		+'</div>'
				                           		+'<div class="right ml-5 ml-sm-0 pl-3 pl-sm-0 text-violet" style="width:7%">'
				                           			+'<a href="empDelete.do?empno='+data.data[0].empno+'"><span>삭제</span></a>'
				                        		+'</div>'
			                  				+'</div>';
							}else {
								$('#selectData').empty();
