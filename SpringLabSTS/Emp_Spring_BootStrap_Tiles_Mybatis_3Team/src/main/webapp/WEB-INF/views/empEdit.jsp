				...
				<div class="col-lg-12 data-padding">
					<div class="card mb-5 mb-lg-0">         
						...
						<div class="card-body body-padding text-center">
				        	...
				        	<form id="editForm" action="empEditOk.htm" class="mt-4" method="post" enctype="multipart/form-data">
				              ...
				              <div class="form-group mb-4"><!-- 입사일 -->
				                <input type="text" id='hiredate' value="${emp.hiredate}" class="form-control border-0 shadow form-control-lg" readonly>
				              </div>
				              ...
				              <div class="form-group mb-4"><!-- 사진 -->
				              	<div class="row">
				                	...
				                	<div style="width: 83%;"><input type="file" name='file' value="${emp.save_picture}" id='emp_img' accept="image/*" class="form-control border-0 shadow form-control-lg text-violet"></div>
				                </div>
				              </div>
				              
				              
				              <button type="submit" id="submit" class="btn btn-primary shadow px-5">Edit</button>
				              <button type="button" id="button" class="btn btn-primary shadow px-5" onclick="location.href='empList.htm'">List</button>
				        	</form>
        				</div>
        			</div>
        		</div>
