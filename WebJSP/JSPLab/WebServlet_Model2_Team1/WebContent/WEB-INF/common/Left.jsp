	...
	<div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
			  ...
			  <c:choose>
   				<c:when test="${id!=null}">
   					<li class="sidebar-list-item">
              			<a href="empList.do" class="sidebar-link text-muted">
              			<i class="o-exit-1 mr-3 text-gray"></i><span>List</span></a>
              		</li>
              		<li class="sidebar-list-item">
              			<a href="empAdd.do" class="sidebar-link text-muted">
              			<i class="o-exit-1 mr-3 text-gray"></i><span>Register</span></a>
              		</li>
              		<li class="sidebar-list-item">
              			<a href="empchart.do" class="sidebar-link text-muted">
              			<i class="o-exit-1 mr-3 text-gray"></i><span>Chart</span></a>
              		</li>
              		<li class="sidebar-list-item">
              			<a href="adminLogout.do" class="sidebar-link text-muted">
              			<i class="o-exit-1 mr-3 text-gray"></i><span>Logout</span></a>
              		</li>
				</c:when>
   				<c:otherwise>
      				<li class="sidebar-list-item">
              			<a href="adminLogin.do" class="sidebar-link text-muted">
