...
<%
    ...
    String sMimeType = getServletContext().getMimeType(FilePath); //파일의 타입 정보 > MimeType : jpg, png, txt, mp3 ...등등 파일의 형식
    if(sMimeType == null){
     //알수 없는 형식의 파일은 
    ...
    // setHeader 파일 다운로드를 위한 헤더 정보 수정 (파일이름 문자열 다시 인코딩)
    ...
    //문서를 읽어 들여서 ISO8859_1 형식으로 변환 ......
    	//파일명을 바이트 형태로 읽어서... ISO8859_1 형식으로 변환해서.... 세계적으로 같은 것...
    
    //attachment 를 쓰면 웹브라우져가 화면에 보여주지 않고 무조건 다운받음..
