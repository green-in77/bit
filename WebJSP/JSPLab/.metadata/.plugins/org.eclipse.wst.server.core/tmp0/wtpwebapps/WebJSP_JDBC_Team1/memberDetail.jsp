					...
					<div class="card mb-5 mb-lg-0">         
						...
						<div class="card-body body-padding text-center">
				              ...
				              <div class="form-group mb-4"><!-- 성별-->
				              	<div class="row">
				              		<div class="col-lg-6">
				                		<input type="radio" name="gender" id="gender" value="여" <%if(rs.getString(5).trim().equals("여")){%>checked<%}%>>여자
				                	</div>
				                	<div class="col-lg-6">
				                		<input type="radio" name="gender" id="gender" value="남" <%if(rs.getString(5).trim().equals("남")){%>checked<%}%>>남자
				                	</div>
				                </div>
				              </div>
